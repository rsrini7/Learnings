...
**Related:**
- [Prompt-Generator-Prompt](Prompt-Generator-Prompt.md) — Meta-prompt whose ANALYZE/CONSTRUCT/OUTPUT process mirrors the document-creation patterns collected under section 1 here.
- [perplexity-research-whitepaper-prompt](../research/perplexity-research-whitepaper-prompt.md) — Whitepaper-generation prompt that implements the same technical-audience whitepaper pattern documented as item 1.2 in this collection.
