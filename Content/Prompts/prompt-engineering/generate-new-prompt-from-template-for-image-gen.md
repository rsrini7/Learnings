...
```
Create a professional, vertical infographic with a light blue background and clean vector art style using bright blue and orange accents. The diagram is hierarchically structured.

[PASTE ALL YOUR CONTENT BELOW - separate sections with "---"]

---CONTENT START---

Main Title: [Your main title]

Left Side: [Description] | Label: [Label text]
Right Side: [Description] | Label: [Label text]

Middle Banner: [Your subtitle/phrase]

Four Categories: [Cat 1] | [Cat 2] | [Cat 3] | [Cat 4]

List Section Title: [Title]
List Items: [Item 1] | [Item 2] | [Item 3]

Footer Title: [Title]
Three Principles: [Principle 1] | [Principle 2] | [Principle 3]

Attribution: Github icon **"Srinivasan Ragothaman (@rsrini7)"** discreetly in the bottom middle
