...
**Related:**
- [Facebook-sparce-memory-finetuning](Facebook-sparce-memory-finetuning.md) — Related continual-learning method targeting the same forgetting problem at the training step level.
- [Titans-GooglePaper](../meta/Titans-GooglePaper.md) — Fellow Google memory work: Nested Learning reorganizes update rates while Titans adds neural long-term memory.
- [ContinualLearning](../../AI-ML/LLMs/training/ContinualLearning.md) — Anchors Nested Learning's continuum memory system within established continual-learning taxonomy.
