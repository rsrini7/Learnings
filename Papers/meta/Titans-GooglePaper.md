...
**Related:**
- [Persistent-Memory-Layers-AI-Agents](../../AI-ML/LLMs/architecture/Persistent-Memory-Layers-AI-Agents.md) — Titans' persistent-memory module maps directly onto persistent memory layer patterns in agent LLM stacks.
- [Beyond-SoftMax-Attention](../../AI-ML/LLMs/attention/Beyond-SoftMax-Attention.md) — Titans' test-time neural memory is positioned alongside softmax-attention alternatives for long-context modeling.
