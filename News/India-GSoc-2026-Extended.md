...
```mermaid
graph TD
    A[Start: Want to do GSoC 2026?] --> B{Are you 18+ years old<br/>by February 27, 2026?}
    B -->|No| C[Wait for GSoC 2027<br/>Focus on skill-building now]
    B -->|Yes| D{Can you commit 12+ weeks<br/>in summer 2026?}
    D -->|No| E[Consider other programs:<br/>LFX part-time, Outreachy]
    D -->|Yes| F{Do you have basic<br/>coding skills?}
    F -->|No| G[Learn fundamentals first<br/>2-3 months minimum]
    F -->|Yes| H[Start NOW!<br/>October 2025 onwards]
    H --> I[Pick 1-2 tech stacks to master]
    I --> J[Research organizations<br/>by November 2025]
    J --> K[Start contributing<br/>by mid-November]
    K --> L[Write proposal<br/>March-April 2026]
    L --> M[Keep contributing<br/>until May 8]
    M --> N{Selected on May 8?}
...
```mermaid
graph LR
    A[Your Contribution Count] --> B{How many quality PRs?}
    B -->|10+ quality merged PRs| C[6-8 page proposal<br/>Focus: WHAT you'll build]
    B -->|5-9 merged PRs| D[8-10 page proposal<br/>Focus: HOW you'll build it]
    B -->|1-4 merged PRs| E[10-12 page proposal<br/>Focus: PROVE you can build it]
    B -->|0 merged PRs| F[Reconsider applying<br/>or 12+ page very detailed]
    
    C --> G[Emphasize:<br/>- Clear deliverables<br/>- Timeline<br/>- Integration approach]
    D --> H[Emphasize:<br/>- Technical architecture<br/>- Implementation steps<br/>- Risk mitigation]
...
```mermaid
graph TD
    A[Start: Considering Organization X] --> B{Technical Match?<br/>Do my skills align<br/>with their stack?}
    B -->|No| C[Skip this org<br/>Would waste your time<br/>and mentors' time]
    B -->|Yes| D{Domain Interest?<br/>Do I care about<br/>what they build?}
    D -->|No| E[Will lose motivation<br/>mid-project]
    D -->|Yes| F{Community Active?<br/>Recent commits,<br/>responsive maintainers?}
    F -->|No| G[Poor mentorship likely<br/>Project may be abandoned]
    F -->|Yes| H{Multi-Year Participation?<br/>Been in GSoC<br/>3+ times?}
    H -->|No - First Time| I{Willing to take risk?<br/>Less competition<br/>but unstable}
    H -->|Yes - Established| J{Competition Level?<br/>Applicants per slot}
    J -->|Very High: 50+/slot| K[Need exceptional<br/>contributions to stand out]
    J -->|Moderate: 10-20/slot| L[Good fit!<br/>Apply here with<br/>solid preparation]
    J -->|Low: <10/slot| M[Great odds if you<br/>have basic qualifications]
    I -->|Yes| N[Luck-based strategy<br/>Could work if org<br/>has few applicants]
    I -->|No| A
    
    K --> O{Do I have<br/>10+ complex PRs?}
    O -->|Yes| L
    O -->|No| P[Consider less<br/>competitive org]
