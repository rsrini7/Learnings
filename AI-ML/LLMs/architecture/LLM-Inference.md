...
- [Jev-Internals-and-Open-Source-Alternatives-2026](../models/other/Jev-Internals-and-Open-Source-Alternatives-2026.md) — A concrete architecture that skips the autoregressive decode phase entirely, hitting the 70–500 ms end-to-end budget this file's decode-bound analysis explains.
