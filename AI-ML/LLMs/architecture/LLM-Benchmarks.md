...
**Related:**
- [microGPT-Technical-Deep-Dive](microGPT-Technical-Deep-Dive.md) — Section 8 'Performance Characteristics' benchmarks microGPT's loss curve as a concrete example of model evaluation methodology.
