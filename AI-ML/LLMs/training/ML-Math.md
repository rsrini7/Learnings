...
This document outlines essential mathematical concepts and resources for Machine Learning.
...
**Resource:** [https://www.deeplearningbook.org/exercises.html](https://www.deeplearningbook.org/exercises.html)
...
4.  Trigonometry (Equations, Inequalities, Functions, Graphs, etc.)
...
Also use Workbooks to do lots of exercises, for example from:
...
*   **Single/Multi-Variable Calculus I, II & III:**
...
*   **Numerical Analysis, Optimization, & Mathematical Models:**
...
### Conclusion on Textbooks

It might be enough to choose 1 or 2 textbooks and 1 workbook for each Math topic.

**Example for Arithmetic, Algebra, Geometry & (Analytic Geometry), Trigonometry:**
...
**Example for Probability & Statistics:** (It is advisable to do the (basic concepts) textbook first).
...
## YouTube and Other Online Math Tutorials

For visual Math clarity and lectures to ease understanding:
...
## Which Math to Study? Pure Math vs Discrete Math vs Applied Math?

### Pure Math

*   Focuses on the (Analysis) of the abstract and the theoretical concepts using proof theorems and research, to make for new Math discoveries.
*   It is generally more difficult than Applied Math.
*   Mainly for students pursuing Mathematics Degrees.
*   **Topics Like:** Set Theory, Abstract Algebra, Number Theory, Analysis, Topology, etc.

### Discrete Math

*   Focuses on the (Concepts & Structures) used to verify by proofs, discrete objects and their relationships in Digital Electronics/Computer Engineering, Computer Science, Software Programming/Engineering, etc.
*   **Topics Like:** Logic, Graphs, Sets, Functions, Relations, Permutations and Finite-State Machines.

### Applied Math

*   Focuses on (Applying) computational Mathematical Modelling methods, also with Numerical Analysis & Methods, and Optimization, to solve real-world problems in many fields, for example in the Applied Sciences, Engineering, and Economics etc.
*   **Fields Like:** Physics, Chemistry, Biology, Statistics, Mechanical, Civil, Electrical, Medicine, Finance etc.
...
**Related:**
- [Glossary](../reference/Glossary.md) — Defines the linear-algebra objects (matrices, norms, parameter vectors) and statistical concepts (distributions, variance) that this curriculum's textbooks teach.
- [microGPT-Architecture-Complete](../architecture/microGPT-Architecture-Complete.md) — Concrete pure-Python application of every concept on this math list: matrix multiplies, gradient descent, backprop, cross-entropy loss, softmax.
