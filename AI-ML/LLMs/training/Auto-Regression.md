...
**Related:**- [microGPT-Architecture-Complete](../architecture/microGPT-Architecture-Complete.md) — MicroGPT's sample-loop-until-BOS is a concrete implementation of the auto-regressive 'next token given previous tokens' mechanic this file explains.- [AI-in-Next-18-Months](../economy/AI-in-Next-18-Months.md) — Profiles Diffusion LLMs as the leading 10x-speedup alternative to the sequential auto-regressive bottleneck detailed here.- [OpenResponses-Open-Inference-Standard](../optimization/OpenResponses-Open-Inference-Standard.md) — Specifies server-side agentic loops whose server-managed decoding effectively inverts the client-orchestrated token-by-token auto-regression this file critiques.- [Beyond-SoftMax-Attention](../attention/Beyond-SoftMax-Attention.md) — Both address the quadratic/long-context bottleneck; Beyond-SoftMax replaces the attention KV store while auto-regression solutions like distillation replace the decode loop.- [Glossary](../reference/Glossary.md) — Defines teacher forcing, exposure bias, and speculative decoding in the same vocabulary used to discuss the speed-quality trade-offs here.
