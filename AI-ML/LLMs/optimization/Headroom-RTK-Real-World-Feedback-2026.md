...
**Related:**
- [multi-agent-rtk-headroom-integration](../../../DevSetup/headroom/multi-agent-rtk-headroom-integration.md) — Master guide on RTK v0.49.0 Homebrew upgrade, multi-agent token optimization across Pi, Codex, and AGY.
