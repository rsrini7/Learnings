...
**Related:**
- [Agent-Skills-vs-Agents.md](Agent-Skills-vs-Agents.md.md) — these five concrete prompts (lead scoring, report builder, survey analyzer) are exactly the 'narrow action-oriented workflows' where Skills still win.
- [claude-agents-vs-sub-agents-vs-projects-vs-workflow-vs-rules-vs-mcp-vs-skills](claude-agents-vs-sub-agents-vs-projects-vs-workflow-vs-rules-vs-mcp-vs-skills.md) — locates these reusable Skills within the broader Claude primitives taxonomy (agents, MCP, Rules, Projects).
