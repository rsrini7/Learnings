...
**Related:**
- [AI-Accelerated-Development-Playbook](AI-Accelerated-Development-Playbook.md) — code-quality and governance playbook that grounds the manual's 70-20-10 split and ROI formulas in measurable engineering practice.
- [Agent-Skills](../skills/Agent-Skills.md) — Skills as the standardization mechanism for the manual's 'vetted prompts stored in team wiki' workflow integration step.
