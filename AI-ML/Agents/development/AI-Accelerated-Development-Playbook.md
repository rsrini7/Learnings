...
**Related:**- [AI-Coding-Loops](AI-Coding-Loops.md) — canonical taxonomy of autonomy loops and harness engineering that explains why the playbook's 'army of juniors' problem keeps recurring.- [Spec-Driven-Development-Frameworks](Spec-Driven-Development-Frameworks.md) — formalizes the playbook's 'first 1,000 lines as a spec' principle into SDD, OpenSpec, Spec Kit, and BMAD workflows.- [AI-Assisted-Development](AI-Assisted-Development.md) — UACF AGENTS.md plus Claude Skills directly implement the 'ai-rules.md' and 'codify standards in tools' guidance here.- [Agent-Skills](../skills/Agent-Skills.md) — Anthropic's Skills standard is the natural packaging mechanism for the playbook's vetted prompts and review checklists.
