...
```mermaid
graph TD
    A[Layer 1: Tokenizable Cognition] --> B[Layer 2: Judgment & Accountability]
    B --> C[Layer 3: Physical Execution]
```
...
```mermaid
graph LR
    L[Digital / Contestable<br>Layer 1 Heavy<br>High Competition] --- M[Mid-tier Firms<br>Squeezed] --- R[Physical & Trusted<br>Layer 2 & 3<br>Resilient]
```
