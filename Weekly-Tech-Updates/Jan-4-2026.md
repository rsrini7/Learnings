...
![assets/Jan-4-2026.png](assets/Jan-4-2026.png)
...
- Meta acquired **Manus** (often misheard as “Manis”) for a reported **$2–3B** valuation, after the startup emerged in 2025 with a browser‑based autonomous agent that can “finish work at scale.”
- Manus is known for a robust “agentic harness” that can execute multi‑step workflows (research, coding, data analysis, ad ops) with minimal human supervision, which Meta plans to wire into its model ecosystem and internal tooling.
- The company will continue to operate its subscription agent product independently for now, but analysts expect **data‑policy changes** as Meta integrates Manus into ads and consumer surfaces.
- References: Reuters; WSJ; TechCrunch / analysis blogs on Manus acquisition.
